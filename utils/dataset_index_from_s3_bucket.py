...
def worker(bucket_name, config, start_date, end_date, func, unsafe, sources_policy, require_lineage, queue, profile_name, endpoint_url, unsigned_requests):
    ...
    #s3 = boto3.resource('s3', endpoint_url=endpoint_url, config=resource_config)
...
# @click.option('--profile_name', default="default", help="Pass the profile to use for the constructed S3 client")
